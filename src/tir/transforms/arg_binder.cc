...
void ArgBinder::BindDLTensor(const Buffer& buffer, const PrimExpr& device_type,
  ...
  PrimExpr cond = (TVMArrayGet(DataType::UInt(16), handle, builtin::kArrTypeCode) ==
                       IntImm(DataType::UInt(16), dtype.code()) &&
                   TVMArrayGet(DataType::UInt(16), handle, builtin::kArrTypeBits) ==
                       IntImm(DataType::UInt(16), dtype.bits()) &&
                   TVMArrayGet(DataType::Int(32), handle, builtin::kArrTypeLanes) ==
